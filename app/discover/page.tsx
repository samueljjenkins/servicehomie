				...
				<div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-xl p-6 shadow-md flex flex-col justify-between">
						<div>
                            ...
                            <p className="text-gray-700 dark:text-gray-200 mb-4 text-sm">
								"Grew to{" "}
                                <span className="font-bold text-blue-600 dark:text-blue-400">2,500+ members</span>{" "}
                                and <span className="font-bold text-blue-600 dark:text-blue-400">$18,000+/mo</span>{" "}
                    ...
                    <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-xl p-6 shadow-md flex flex-col justify-between">
						<div>
                            ...
                            <p className="text-gray-700 dark:text-gray-200 mb-4 text-sm">
								"Retention jumped to{" "}
                                <span className="font-bold text-blue-600 dark:text-blue-400">92%</span>. Affiliate
								program brought in{" "}
                                <span className="font-bold text-blue-600 dark:text-blue-400">$4,000+</span> last
								quarter."
							</p>
						</div>
						<a
