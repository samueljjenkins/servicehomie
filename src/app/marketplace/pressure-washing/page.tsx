  ...
  useEffect(() => {
    async function loadTechnicians() {
      try {
        ...
        const data = await getTechnicians('Pressure Washing');
        setTechnicians(data);
      } catch (err) {
    ...
    <section className="py-20 bg-gray-50 min-h-[80vh]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Pressure Washing</h1>
          <p className="text-lg text-gray-500">Restore the look of your driveway, siding, and more. Book a top-rated pro below:</p>
        </div>
